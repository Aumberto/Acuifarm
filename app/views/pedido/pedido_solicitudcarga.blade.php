...
<div class="container">
<form action="../pedido/solicitudcarga" id="formulario_solicitudpago" class="form-inline">
        <div class="form-group"> 
          <label for="semana_id" class="input-lg">Pedidos a cargar durante la semana</label>
