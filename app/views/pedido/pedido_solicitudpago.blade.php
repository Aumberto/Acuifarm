...
<div class="container">
<form action="../pedido/solicitudpago" id="formulario_solicitudpago" class="form-inline">
        <div class="form-group"> 
          <label for="semana_id" class="input-lg">Pedidos a pagar durante la semana</label>
